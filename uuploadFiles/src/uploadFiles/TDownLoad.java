...
//        uuidFileName = uuidFileName.substring(uuidFileName.indexOf("_")+1);
        ...
        System.out.println("TDTDTDTDTDTDTDTDTDTDTDTD"+realPath);
...
//        String fullPath = realPath+File.separator+uuidFileName;
        System.out.println("TDTDTDTDTDTDTDTDTDTDTDTD"+fullPath);
        //告知客户端以下载的方式

...
public class LShowAllFiles extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //得到所有可以下载的文件名字
        String realPath = getServletContext().getRealPath("/WEB-INF/file/"+Sno+"/"+Species);
        
        System.out.println("LSLSLSLSLSLSLSLSLSLSLSLS"+realPath);
        System.out.println("LSLSLSLSLSLSLSLSLSLSLSLS:   sno="+Sno+"Ssubject=");

...
public class TUpload extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("TUTUTUTUTUTUTUTUTUTU     Sno="+Sno+"Ssubject="+Species);
...
//		sfu.setSizeMax(5*1024*1024);//总文件大小
		...
		for(FileItem item:items){
			...
			//处理上传字段
				processUploadField(item,Sno,Ssubject,Species);
			}
	...
	protected void processUploadField(FileItem item, String Sno, String Ssubject, String Species) {
		try {
...
//				}
				...
				System.out.println("TUTUTUTUTUTUTUTUTUTU"+realPath);

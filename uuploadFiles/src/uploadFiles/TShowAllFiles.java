...
public class TShowAllFiles extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("tststststststststststs"+realPath);
        System.out.println("tststststststststststs:   sno="+Sno+"Ssubject="+Ssubject);
		...
		request.getRequestDispatcher("/tlistFiles.jsp").forward(request, response);
